 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ImageConfig implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ImageConfig';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->container['attachStdout'] = isset($data['attachStdout']) ? $data['attachStdout'] : false;
        $this->container['attachStderr'] = isset($data['attachStderr']) ? $data['attachStderr'] : false;
        ...
        $this->container['image'] = isset($data['image']) ? $data['image'] : '';
        ...
        $this->container['networkDisabled'] = isset($data['networkDisabled']) ? $data['networkDisabled'] : false;
        $this->container['macAddress'] = isset($data['macAddress']) ? $data['macAddress'] : '';
     ...
     * Sets hostname
     *
     * @param string $hostname The hostname to use for the container, as a valid RFC 1123 hostname.  <p><br /></p>  > **Deprecated**: this field is not part of the image specification and is > always empty. It must not be used, and will be removed in API v1.48.
     *
     * @return $this
     */
     ...
     * Sets domainname
     *
     * @param string $domainname The domain name to use for the container.  <p><br /></p>  > **Deprecated**: this field is not part of the image specification and is > always empty. It must not be used, and will be removed in API v1.48.
     *
     * @return $this
     */
     ...
     * Sets attachStdin
     *
     * @param bool $attachStdin Whether to attach to `stdin`.  <p><br /></p>  > **Deprecated**: this field is not part of the image specification and is > always false. It must not be used, and will be removed in API v1.48.
     *
     * @return $this
     */
     ...
     * Sets attachStdout
     *
     * @param bool $attachStdout Whether to attach to `stdout`.  <p><br /></p>  > **Deprecated**: this field is not part of the image specification and is > always false. It must not be used, and will be removed in API v1.48.
     *
     * @return $this
     */
     ...
     * Sets attachStderr
     *
     * @param bool $attachStderr Whether to attach to `stderr`.  <p><br /></p>  > **Deprecated**: this field is not part of the image specification and is > always false. It must not be used, and will be removed in API v1.48.
     *
     * @return $this
     */
     ...
     * Sets tty
     *
     * @param bool $tty Attach standard streams to a TTY, including `stdin` if it is not closed.  <p><br /></p>  > **Deprecated**: this field is not part of the image specification and is > always false. It must not be used, and will be removed in API v1.48.
     *
     * @return $this
     */
     ...
     * Sets openStdin
     *
     * @param bool $openStdin Open `stdin`  <p><br /></p>  > **Deprecated**: this field is not part of the image specification and is > always false. It must not be used, and will be removed in API v1.48.
     *
     * @return $this
     */
     ...
     * Sets stdinOnce
     *
     * @param bool $stdinOnce Close `stdin` after one attached client disconnects.  <p><br /></p>  > **Deprecated**: this field is not part of the image specification and is > always false. It must not be used, and will be removed in API v1.48.
     *
     * @return $this
     */
     ...
     * Sets image
     *
     * @param string $image The name (or reference) of the image to use when creating the container, or which was used when the container was created.  <p><br /></p>  > **Deprecated**: this field is not part of the image specification and is > always empty. It must not be used, and will be removed in API v1.48.
     *
     * @return $this
     */
     ...
     *
     * @param bool $networkDisabled Disable networking for the container.  <p><br /></p>  > **Deprecated**: this field is not part of the image specification and is > always omitted. It must not be used, and will be removed in API v1.48.
     *
     * @return $this
     */
     ...
     * Sets macAddress
     *
     * @param string $macAddress MAC address of the container.  <p><br /></p>  > **Deprecated**: this field is not part of the image specification and is > always omitted. It must not be used, and will be removed in API v1.48.
     *
     * @return $this
     */
     ...
     * Sets stopTimeout
     *
     * @param int $stopTimeout Timeout to stop a container in seconds.  <p><br /></p>  > **Deprecated**: this field is not part of the image specification and is > always omitted. It must not be used, and will be removed in API v1.48.
     *
     * @return $this
     */
