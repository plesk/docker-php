...
class EndpointSpec implements ModelInterface, ArrayAccess
{
     ...
     * Sets ports
     *
     * @param \Docker\API\Model\EndpointPortConfig[] $ports List of exposed ports that this service is accessible on from the outside. Ports can only be provided if `vip` resolution mode is used.
     *
     * @return $this
     */
