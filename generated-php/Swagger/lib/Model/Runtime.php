...
class Runtime implements ModelInterface, ArrayAccess
{
     ...
     * Sets runtimeArgs
     *
     * @param string[] $runtimeArgs List of command-line arguments to pass to the runtime when invoked.
     *
     * @return $this
     */
