...
class PortBinding implements ModelInterface, ArrayAccess
{
     ...
     * Sets hostIp
     *
     * @param string $hostIp Host IP address that the container's port is mapped to.
     *
     * @return $this
     */
     ...
     * Sets hostPort
     *
     * @param string $hostPort Host port number that the container's port is mapped to.
     *
     * @return $this
     */
