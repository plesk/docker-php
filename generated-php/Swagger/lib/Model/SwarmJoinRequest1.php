...
/**
 * SwarmJoinRequest1 Class Doc Comment
 *
 * @category Class
 * @package  Docker\API
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SwarmJoinRequest1 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SwarmJoinRequest_1';
     ...
     * Sets listenAddr
     *
     * @param string $listenAddr Listen address used for inter-manager communication if the node gets promoted to manager, as well as determining the networking interface used for the VXLAN Tunnel Endpoint (VTEP).
     *
     * @return $this
     */
     ...
     * Sets remoteAddrs
     *
     * @param string[] $remoteAddrs Addresses of manager nodes already participating in the swarm.
     *
     * @return $this
     */
     ...
     * Sets joinToken
     *
     * @param string $joinToken Secret token for joining this swarm.
     *
     * @return $this
     */
