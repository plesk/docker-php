...
class ServiceSpec implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'taskTemplate' => '\Docker\API\Model\TaskSpec',
        'mode' => '\Docker\API\Model\ServiceSpecMode',
        'updateConfig' => '\Docker\API\Model\ServiceSpecUpdateConfig',
        'rollbackConfig' => '\Docker\API\Model\ServiceSpecRollbackConfig',
        'networks' => '\Docker\API\Model\NetworkAttachmentConfig[]',
        'endpointSpec' => '\Docker\API\Model\EndpointSpec'
    ];
     ...
     * Sets taskTemplate
     *
     * @param \Docker\API\Model\TaskSpec $taskTemplate taskTemplate
     *
     * @return $this
     */
     ...
     * Gets mode
     *
     * @return \Docker\API\Model\ServiceSpecMode
     */
     ...
     * Sets mode
     *
     * @param \Docker\API\Model\ServiceSpecMode $mode mode
     *
     * @return $this
     */
     ...
     * Gets updateConfig
     *
     * @return \Docker\API\Model\ServiceSpecUpdateConfig
     */
     ...
     * Sets updateConfig
     *
     * @param \Docker\API\Model\ServiceSpecUpdateConfig $updateConfig updateConfig
     *
     * @return $this
     */
     ...
     * Gets rollbackConfig
     *
     * @return \Docker\API\Model\ServiceSpecRollbackConfig
     */
     ...
     * Sets rollbackConfig
     *
     * @param \Docker\API\Model\ServiceSpecRollbackConfig $rollbackConfig rollbackConfig
     *
     * @return $this
     */
     ...
     * Sets networks
     *
     * @param \Docker\API\Model\NetworkAttachmentConfig[] $networks Specifies which networks the service should attach to.  Deprecated: This field is deprecated since v1.44. The Networks field in TaskSpec should be used instead.
     *
     * @return $this
     */
     ...
     * Gets endpointSpec
     *
     * @return \Docker\API\Model\EndpointSpec
     */
     ...
     * Sets endpointSpec
     *
     * @param \Docker\API\Model\EndpointSpec $endpointSpec endpointSpec
     *
     * @return $this
     */
