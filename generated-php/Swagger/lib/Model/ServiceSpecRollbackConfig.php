...
class ServiceSpecRollbackConfig implements ModelInterface, ArrayAccess
{
     ...
     * Sets failureAction
     *
     * @param string $failureAction Action to take if an rolled back task fails to run, or stops running during the rollback.
     *
     * @return $this
     */
     ...
     *
     * @param float $maxFailureRatio The fraction of tasks that may fail during a rollback before the failure action is invoked, specified as a floating point number between 0 and 1.
     *
     * @return $this
     */
