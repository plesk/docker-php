...
class PluginApi
{
     ...
     * @throws \Docker\API\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Docker\API\Model\PluginPrivilege[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getPluginPrivilegesWithHttpInfo($remote)
    {
        $returnType = '\Docker\API\Model\PluginPrivilege[]';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Docker\API\Model\PluginPrivilege[]',
     ...
     */
    protected function getPluginPrivilegesRequest($remote): RequestInterface
    {
     ...
     * @return RequestInterface
     */
    protected function pluginCreateRequest($name, $body = null): RequestInterface
    {
     ...
     * @throws \Docker\API\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Docker\API\Model\Plugin, HTTP status code, HTTP response headers (array of strings)
     */
    public function pluginDeleteWithHttpInfo($name, $force = 'false')
    {
        $returnType = '\Docker\API\Model\Plugin';
     ...
     * @return RequestInterface
     */
    protected function pluginDeleteRequest($name, $force = 'false'): RequestInterface
    {
        // verify the required parameter 'name' is set
        if ($name === null || (is_array($name) && count($name) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return void
     */
    public function pluginDisable($name, $force = null)
    {
        $this->pluginDisableWithHttpInfo($name, $force);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function pluginDisableWithHttpInfo($name, $force = null)
    {
        $returnType = '';
        $request = $this->pluginDisableRequest($name, $force);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function pluginDisableAsync($name, $force = null)
    {
        return $this->pluginDisableAsyncWithHttpInfo($name, $force)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function pluginDisableAsyncWithHttpInfo($name, $force = null)
    {
        $returnType = '';
        $request = $this->pluginDisableRequest($name, $force);
     ...
     * @return RequestInterface
     */
    protected function pluginDisableRequest($name, $force = null): RequestInterface
    {
        // verify the required parameter 'name' is set
        if ($name === null || (is_array($name) && count($name) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return RequestInterface
     */
    protected function pluginEnableRequest($name, $timeout = '0'): RequestInterface
    {
        // verify the required parameter 'name' is set
        if ($name === null || (is_array($name) && count($name) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return RequestInterface
     */
    protected function pluginInspectRequest($name): RequestInterface
    {
        // verify the required parameter 'name' is set
        if ($name === null || (is_array($name) && count($name) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return RequestInterface
     */
    protected function pluginListRequest($filters = null): RequestInterface
    {
     ...
     * @param  \Docker\API\Model\PluginPrivilege[] $body body (optional)
     * @param  string $xRegistryAuth A base64url-encoded auth configuration to use when pulling a plugin from a registry.  Refer to the [authentication section](#section/Authentication) for details. (optional)
     ...
     * @return void
     */
    public function pluginPull($remote, $body = null, $xRegistryAuth = null, $name = null)
    {
        $this->pluginPullWithHttpInfo($remote, $body, $xRegistryAuth, $name);
    }
     ...
     *
     * @param  string $remote Remote reference for plugin to install.  The &#x60;:latest&#x60; tag is optional, and is used as the default if omitted. (required)
     * @param  \Docker\API\Model\PluginPrivilege[] $body (optional)
     * @param  string $xRegistryAuth A base64url-encoded auth configuration to use when pulling a plugin from a registry.  Refer to the [authentication section](#section/Authentication) for details. (optional)
     * @param  string $name Local name for the pulled plugin.  The &#x60;:latest&#x60; tag is optional, and is used as the default if omitted. (optional)
     *
     * @throws \Docker\API\ApiException on non-2xx response
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function pluginPullWithHttpInfo($remote, $body = null, $xRegistryAuth = null, $name = null)
    {
        $returnType = '';
        $request = $this->pluginPullRequest($remote, $body, $xRegistryAuth, $name);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function pluginPullAsync($remote, $body = null, $xRegistryAuth = null, $name = null)
    {
        return $this->pluginPullAsyncWithHttpInfo($remote, $body, $xRegistryAuth, $name)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function pluginPullAsyncWithHttpInfo($remote, $body = null, $xRegistryAuth = null, $name = null)
    {
        $returnType = '';
        $request = $this->pluginPullRequest($remote, $body, $xRegistryAuth, $name);
     ...
     * @return RequestInterface
     */
    protected function pluginPullRequest($remote, $body = null, $xRegistryAuth = null, $name = null): RequestInterface
    {
        // verify the required parameter 'remote' is set
        if ($remote === null || (is_array($remote) && count($remote) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return RequestInterface
     */
    protected function pluginPushRequest($name): RequestInterface
    {
        // verify the required parameter 'name' is set
        if ($name === null || (is_array($name) && count($name) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return RequestInterface
     */
    protected function pluginSetRequest($name, $body = null): RequestInterface
    {
        // verify the required parameter 'name' is set
        if ($name === null || (is_array($name) && count($name) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return void
     */
    public function pluginUpgrade($remote, $name, $body = null, $xRegistryAuth = null)
    {
        $this->pluginUpgradeWithHttpInfo($remote, $name, $body, $xRegistryAuth);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function pluginUpgradeWithHttpInfo($remote, $name, $body = null, $xRegistryAuth = null)
    {
        $returnType = '';
        $request = $this->pluginUpgradeRequest($remote, $name, $body, $xRegistryAuth);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function pluginUpgradeAsync($remote, $name, $body = null, $xRegistryAuth = null)
    {
        return $this->pluginUpgradeAsyncWithHttpInfo($remote, $name, $body, $xRegistryAuth)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function pluginUpgradeAsyncWithHttpInfo($remote, $name, $body = null, $xRegistryAuth = null)
    {
        $returnType = '';
        $request = $this->pluginUpgradeRequest($remote, $name, $body, $xRegistryAuth);
     ...
     * @return RequestInterface
     */
    protected function pluginUpgradeRequest($remote, $name, $body = null, $xRegistryAuth = null): RequestInterface
    {
        // verify the required parameter 'remote' is set
        if ($remote === null || (is_array($remote) && count($remote) === 0)) {
            throw new \InvalidArgumentException(
