...
class VolumeApi
{
     ...
     * Create a volume
     *
     * @param  \Docker\API\Model\VolumeCreateOptions $body Volume configuration (required)
     *
     ...
     * @throws \Docker\API\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Docker\API\Model\Volume, HTTP status code, HTTP response headers (array of strings)
     */
    public function volumeCreateWithHttpInfo($body)
    {
        $returnType = '\Docker\API\Model\Volume';
     ...
     */
    protected function volumeCreateRequest($body): RequestInterface
    {
     ...
     * @return RequestInterface
     */
    protected function volumeDeleteRequest($name, $force = 'false'): RequestInterface
    {
     ...
     * @return RequestInterface
     */
    protected function volumeInspectRequest($name): RequestInterface
    {
        // verify the required parameter 'name' is set
        if ($name === null || (is_array($name) && count($name) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @throws \Docker\API\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Docker\API\Model\VolumeListResponse
     */
     ...
     * @throws \Docker\API\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Docker\API\Model\VolumeListResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function volumeListWithHttpInfo($filters = null)
    {
        $returnType = '\Docker\API\Model\VolumeListResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Docker\API\Model\VolumeListResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return RequestInterface
     */
    protected function volumeListRequest($filters = null): RequestInterface
    {
     ...
     * @throws \Docker\API\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Docker\API\Model\VolumePruneResponse
     */
     ...
     * @throws \Docker\API\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Docker\API\Model\VolumePruneResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function volumePruneWithHttpInfo($filters = null)
    {
        $returnType = '\Docker\API\Model\VolumePruneResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Docker\API\Model\VolumePruneResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return RequestInterface
     */
    protected function volumePruneRequest($filters = null): RequestInterface
    {
     ...
     * @param  \Docker\API\Model\VolumesNameBody $body The spec of the volume to update. Currently, only Availability may change. All other fields must remain unchanged. (optional)
     *
     * @throws \Docker\API\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function volumeUpdate($version, $name, $body = null)
    {
        $this->volumeUpdateWithHttpInfo($version, $name, $body);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function volumeUpdateWithHttpInfo($version, $name, $body = null)
    {
        $returnType = '';
        $request = $this->volumeUpdateRequest($version, $name, $body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function volumeUpdateAsync($version, $name, $body = null)
    {
        return $this->volumeUpdateAsyncWithHttpInfo($version, $name, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function volumeUpdateAsyncWithHttpInfo($version, $name, $body = null)
    {
        $returnType = '';
        $request = $this->volumeUpdateRequest($version, $name, $body);
     ...
     * @return RequestInterface
     */
    protected function volumeUpdateRequest($version, $name, $body = null): RequestInterface
    {
