...
class TaskApi
{
     ...
     * @throws \Docker\API\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Docker\API\Model\Task, HTTP status code, HTTP response headers (array of strings)
     */
    public function taskInspectWithHttpInfo($id)
    {
        $returnType = '\Docker\API\Model\Task';
     ...
     */
    protected function taskInspectRequest($id): RequestInterface
    {
     ...
     * @return RequestInterface
     */
    protected function taskListRequest($filters = null): RequestInterface
    {
     ...
     * @return RequestInterface
     */
    protected function taskLogsRequest($id, $details = 'false', $follow = 'false', $stdout = 'false', $stderr = 'false', $since = '0', $timestamps = 'false', $tail = 'all'): RequestInterface
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
