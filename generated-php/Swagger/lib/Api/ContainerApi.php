...
class ContainerApi
{
     ...
     */
    protected function containerArchiveRequest($id, $path): RequestInterface
    {
     ...
     * @return RequestInterface
     */
    protected function containerArchiveInfoRequest($id, $path): RequestInterface
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return RequestInterface
     */
    protected function containerAttachRequest($id, $detachKeys = null, $logs = 'false', $stream = 'false', $stdin = 'false', $stdout = 'false', $stderr = 'false'): RequestInterface
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        // query params
        if ($detachKeys !== null) {
            $queryParams['detachKeys'] = ObjectSerializer::toQueryValue($detachKeys, null);
        }
        // query params
        if ($logs !== null) {
     ...
     * @return RequestInterface
     */
    protected function containerAttachWebsocketRequest($id, $detachKeys = null, $logs = 'false', $stream = 'false', $stdin = 'false', $stdout = 'false', $stderr = 'false'): RequestInterface
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @throws \Docker\API\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Docker\API\Model\FilesystemChange[]
     */
     ...
     * @throws \Docker\API\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Docker\API\Model\FilesystemChange[], HTTP status code, HTTP response headers (array of strings)
     */
    public function containerChangesWithHttpInfo($id)
    {
        $returnType = '\Docker\API\Model\FilesystemChange[]';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Docker\API\Model\FilesystemChange[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return RequestInterface
     */
    protected function containerChangesRequest($id): RequestInterface
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * Create a container
     *
     * @param  \Docker\API\Model\ContainersCreateBody $body Container to create (required)
     ...
     * @throws \Docker\API\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Docker\API\Model\ContainerCreateResponse
     */
    public function containerCreate($body, $name = null, $platform = null)
    {
        list($response) = $this->containerCreateWithHttpInfo($body, $name, $platform);
        return $response;
    }
     ...
     * @throws \Docker\API\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Docker\API\Model\ContainerCreateResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function containerCreateWithHttpInfo($body, $name = null, $platform = null)
    {
        $returnType = '\Docker\API\Model\ContainerCreateResponse';
        $request = $this->containerCreateRequest($body, $name, $platform);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Docker\API\Model\ContainerCreateResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function containerCreateAsync($body, $name = null, $platform = null)
    {
        return $this->containerCreateAsyncWithHttpInfo($body, $name, $platform)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function containerCreateAsyncWithHttpInfo($body, $name = null, $platform = null)
    {
        $returnType = '\Docker\API\Model\ContainerCreateResponse';
        $request = $this->containerCreateRequest($body, $name, $platform);
     ...
     * @return RequestInterface
     */
    protected function containerCreateRequest($body, $name = null, $platform = null): RequestInterface
    {
     ...
     * @return RequestInterface
     */
    protected function containerDeleteRequest($id, $v = 'false', $force = 'false', $link = 'false'): RequestInterface
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return RequestInterface
     */
    protected function containerExportRequest($id): RequestInterface
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @throws \Docker\API\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Docker\API\Model\ContainerInspectResponse
     */
     ...
     * @throws \Docker\API\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Docker\API\Model\ContainerInspectResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function containerInspectWithHttpInfo($id, $size = 'false')
    {
        $returnType = '\Docker\API\Model\ContainerInspectResponse';
     ...
     * @return RequestInterface
     */
    protected function containerInspectRequest($id, $size = 'false'): RequestInterface
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return RequestInterface
     */
    protected function containerKillRequest($id, $signal = 'SIGKILL'): RequestInterface
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @throws \Docker\API\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Docker\API\Model\ContainerSummary[], HTTP status code, HTTP response headers (array of strings)
     */
    public function containerListWithHttpInfo($all = 'false', $limit = null, $size = 'false', $filters = null)
    {
        $returnType = '\Docker\API\Model\ContainerSummary[]';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Docker\API\Model\ContainerSummary[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return RequestInterface
     */
    protected function containerListRequest($all = 'false', $limit = null, $size = 'false', $filters = null): RequestInterface
    {
     ...
     * @return RequestInterface
     */
    protected function containerLogsRequest($id, $follow = 'false', $stdout = 'false', $stderr = 'false', $since = '0', $until = '0', $timestamps = 'false', $tail = 'all'): RequestInterface
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return RequestInterface
     */
    protected function containerPauseRequest($id): RequestInterface
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @throws \Docker\API\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Docker\API\Model\ContainerPruneResponse
     */
     ...
     * @throws \Docker\API\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Docker\API\Model\ContainerPruneResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function containerPruneWithHttpInfo($filters = null)
    {
        $returnType = '\Docker\API\Model\ContainerPruneResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Docker\API\Model\ContainerPruneResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return RequestInterface
     */
    protected function containerPruneRequest($filters = null): RequestInterface
    {
     ...
     * @return RequestInterface
     */
    protected function containerRenameRequest($id, $name): RequestInterface
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return void
     */
    public function containerResize($id, $h, $w)
    {
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function containerResizeWithHttpInfo($id, $h, $w)
    {
        $returnType = '';
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function containerResizeAsync($id, $h, $w)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function containerResizeAsyncWithHttpInfo($id, $h, $w)
    {
        $returnType = '';
        $request = $this->containerResizeRequest($id, $h, $w);
     ...
     * @return RequestInterface
     */
    protected function containerResizeRequest($id, $h, $w): RequestInterface
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return void
     */
    public function containerRestart($id, $signal = null, $t = null)
    {
        $this->containerRestartWithHttpInfo($id, $signal, $t);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function containerRestartWithHttpInfo($id, $signal = null, $t = null)
    {
        $returnType = '';
        $request = $this->containerRestartRequest($id, $signal, $t);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function containerRestartAsync($id, $signal = null, $t = null)
    {
        return $this->containerRestartAsyncWithHttpInfo($id, $signal, $t)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function containerRestartAsyncWithHttpInfo($id, $signal = null, $t = null)
    {
        $returnType = '';
        $request = $this->containerRestartRequest($id, $signal, $t);
     ...
     * @return RequestInterface
     */
    protected function containerRestartRequest($id, $signal = null, $t = null): RequestInterface
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return RequestInterface
     */
    protected function containerStartRequest($id, $detachKeys = null): RequestInterface
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @param  bool $oneShot Only get a single stat instead of waiting for 2 cycles. Must be used with &#x60;stream&#x3D;false&#x60;. (optional, default to false)
     *
     * @throws \Docker\API\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object
     */
    public function containerStats($id, $stream = 'true', $oneShot = 'false')
    {
        list($response) = $this->containerStatsWithHttpInfo($id, $stream, $oneShot);
        return $response;
    }
     ...
     */
    public function containerStatsWithHttpInfo($id, $stream = 'true', $oneShot = 'false')
    {
        $returnType = 'object';
        $request = $this->containerStatsRequest($id, $stream, $oneShot);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function containerStatsAsync($id, $stream = 'true', $oneShot = 'false')
    {
        return $this->containerStatsAsyncWithHttpInfo($id, $stream, $oneShot)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function containerStatsAsyncWithHttpInfo($id, $stream = 'true', $oneShot = 'false')
    {
        $returnType = 'object';
        $request = $this->containerStatsRequest($id, $stream, $oneShot);
     ...
     * @return RequestInterface
     */
    protected function containerStatsRequest($id, $stream = 'true', $oneShot = 'false'): RequestInterface
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        // query params
        if ($oneShot !== null) {
            $queryParams['one-shot'] = ObjectSerializer::toQueryValue($oneShot, null);
        }
     ...
     * @return void
     */
    public function containerStop($id, $signal = null, $t = null)
    {
        $this->containerStopWithHttpInfo($id, $signal, $t);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function containerStopWithHttpInfo($id, $signal = null, $t = null)
    {
        $returnType = '';
        $request = $this->containerStopRequest($id, $signal, $t);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function containerStopAsync($id, $signal = null, $t = null)
    {
        return $this->containerStopAsyncWithHttpInfo($id, $signal, $t)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function containerStopAsyncWithHttpInfo($id, $signal = null, $t = null)
    {
        $returnType = '';
        $request = $this->containerStopRequest($id, $signal, $t);
     ...
     * @return RequestInterface
     */
    protected function containerStopRequest($id, $signal = null, $t = null): RequestInterface
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @throws \Docker\API\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Docker\API\Model\ContainerTopResponse
     */
     ...
     * @throws \Docker\API\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Docker\API\Model\ContainerTopResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function containerTopWithHttpInfo($id, $psArgs = '-ef')
    {
        $returnType = '\Docker\API\Model\ContainerTopResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Docker\API\Model\ContainerTopResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return RequestInterface
     */
    protected function containerTopRequest($id, $psArgs = '-ef'): RequestInterface
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        // query params
        if ($psArgs !== null) {
            $queryParams['ps_args'] = ObjectSerializer::toQueryValue($psArgs, null);
        }
     ...
     * @return RequestInterface
     */
    protected function containerUnpauseRequest($id): RequestInterface
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * Update a container
     *
     * @param  \Docker\API\Model\IdUpdateBody $body body (required)
     * @param  string $id ID or name of the container (required)
     *
     * @throws \Docker\API\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Docker\API\Model\ContainerUpdateResponse
     */
     ...
     * Update a container
     *
     * @param  \Docker\API\Model\IdUpdateBody $body (required)
     * @param  string $id ID or name of the container (required)
     *
     * @throws \Docker\API\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Docker\API\Model\ContainerUpdateResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function containerUpdateWithHttpInfo($body, $id)
    {
        $returnType = '\Docker\API\Model\ContainerUpdateResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Docker\API\Model\ContainerUpdateResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return RequestInterface
     */
    protected function containerUpdateRequest($body, $id): RequestInterface
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @throws \Docker\API\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Docker\API\Model\ContainerWaitResponse
     */
     ...
     * @throws \Docker\API\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Docker\API\Model\ContainerWaitResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function containerWaitWithHttpInfo($id, $condition = 'not-running')
    {
        $returnType = '\Docker\API\Model\ContainerWaitResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Docker\API\Model\ContainerWaitResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return RequestInterface
     */
    protected function containerWaitRequest($id, $condition = 'not-running'): RequestInterface
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     *
     * @param  Object $body The input stream must be a tar archive compressed with one of the following algorithms: &#x60;identity&#x60; (no compression), &#x60;gzip&#x60;, &#x60;bzip2&#x60;, or &#x60;xz&#x60;. (required)
     ...
     * @return void
     */
    public function putContainerArchive($body, $path, $id, $noOverwriteDirNonDir = null, $copyUIDGID = null)
    {
        $this->putContainerArchiveWithHttpInfo($body, $path, $id, $noOverwriteDirNonDir, $copyUIDGID);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function putContainerArchiveWithHttpInfo($body, $path, $id, $noOverwriteDirNonDir = null, $copyUIDGID = null)
    {
        $returnType = '';
        $request = $this->putContainerArchiveRequest($body, $path, $id, $noOverwriteDirNonDir, $copyUIDGID);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function putContainerArchiveAsync($body, $path, $id, $noOverwriteDirNonDir = null, $copyUIDGID = null)
    {
        return $this->putContainerArchiveAsyncWithHttpInfo($body, $path, $id, $noOverwriteDirNonDir, $copyUIDGID)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function putContainerArchiveAsyncWithHttpInfo($body, $path, $id, $noOverwriteDirNonDir = null, $copyUIDGID = null)
    {
        $returnType = '';
        $request = $this->putContainerArchiveRequest($body, $path, $id, $noOverwriteDirNonDir, $copyUIDGID);
     ...
     * @return RequestInterface
     */
    protected function putContainerArchiveRequest($body, $path, $id, $noOverwriteDirNonDir = null, $copyUIDGID = null): RequestInterface
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($noOverwriteDirNonDir !== null) {
            $queryParams['noOverwriteDirNonDir'] = ObjectSerializer::toQueryValue($noOverwriteDirNonDir, null);
        }
        // query params
        if ($copyUIDGID !== null) {
            $queryParams['copyUIDGID'] = ObjectSerializer::toQueryValue($copyUIDGID, null);
        }
