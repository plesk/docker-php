...
class DistributionApi
{
     ...
     * @throws \Docker\API\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Docker\API\Model\DistributionInspect, HTTP status code, HTTP response headers (array of strings)
     */
    public function distributionInspectWithHttpInfo($name)
    {
        $returnType = '\Docker\API\Model\DistributionInspect';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Docker\API\Model\DistributionInspect',
     ...
     */
    protected function distributionInspectRequest($name): RequestInterface
    {
