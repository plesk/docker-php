...
class ServiceApi
{
     ...
     * Create a service
     *
     * @param  \Docker\API\Model\ServicesCreateBody $body body (required)
     * @param  string $xRegistryAuth A base64url-encoded auth configuration for pulling from private registries.  Refer to the [authentication section](#section/Authentication) for details. (optional)
     *
     * @throws \Docker\API\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Docker\API\Model\ServiceCreateResponse
     */
     ...
     * Create a service
     *
     * @param  \Docker\API\Model\ServicesCreateBody $body (required)
     * @param  string $xRegistryAuth A base64url-encoded auth configuration for pulling from private registries.  Refer to the [authentication section](#section/Authentication) for details. (optional)
     *
     * @throws \Docker\API\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Docker\API\Model\ServiceCreateResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function serviceCreateWithHttpInfo($body, $xRegistryAuth = null)
    {
        $returnType = '\Docker\API\Model\ServiceCreateResponse';
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Docker\API\Model\ServiceCreateResponse',
     ...
     */
    protected function serviceCreateRequest($body, $xRegistryAuth = null): RequestInterface
    {
     ...
     * @return RequestInterface
     */
    protected function serviceDeleteRequest($id): RequestInterface
    {
     ...
     * @throws \Docker\API\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Docker\API\Model\Service, HTTP status code, HTTP response headers (array of strings)
     */
    public function serviceInspectWithHttpInfo($id, $insertDefaults = 'false')
    {
        $returnType = '\Docker\API\Model\Service';
     ...
     * @return RequestInterface
     */
    protected function serviceInspectRequest($id, $insertDefaults = 'false'): RequestInterface
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($insertDefaults !== null) {
            $queryParams['insertDefaults'] = ObjectSerializer::toQueryValue($insertDefaults, null);
        }
     ...
     * @return RequestInterface
     */
    protected function serviceListRequest($filters = null, $status = null): RequestInterface
    {
     ...
     * @return RequestInterface
     */
    protected function serviceLogsRequest($id, $details = 'false', $follow = 'false', $stdout = 'false', $stderr = 'false', $since = '0', $timestamps = 'false', $tail = 'all'): RequestInterface
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * Update a service
     *
     * @param  \Docker\API\Model\IdUpdateBody1 $body body (required)
     ...
     */
    public function serviceUpdate($body, $version, $id, $xRegistryAuth = null, $registryAuthFrom = 'spec', $rollback = null)
    {
        list($response) = $this->serviceUpdateWithHttpInfo($body, $version, $id, $xRegistryAuth, $registryAuthFrom, $rollback);
        return $response;
    }
     ...
     * Update a service
     *
     * @param  \Docker\API\Model\IdUpdateBody1 $body (required)
     * @param  int $version The version number of the service object being updated. This is required to avoid conflicting writes. This version number should be the value as currently set on the service *before* the update. You can find the current version by calling &#x60;GET /services/{id}&#x60; (required)
     * @param  string $id ID or name of service. (required)
     * @param  string $xRegistryAuth A base64url-encoded auth configuration for pulling from private registries.  Refer to the [authentication section](#section/Authentication) for details. (optional)
     * @param  string $registryAuthFrom If the &#x60;X-Registry-Auth&#x60; header is not specified, this parameter indicates where to find registry authorization credentials. (optional, default to spec)
     ...
     * @throws \Docker\API\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Docker\API\Model\ServiceUpdateResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function serviceUpdateWithHttpInfo($body, $version, $id, $xRegistryAuth = null, $registryAuthFrom = 'spec', $rollback = null)
    {
        $returnType = '\Docker\API\Model\ServiceUpdateResponse';
        $request = $this->serviceUpdateRequest($body, $version, $id, $xRegistryAuth, $registryAuthFrom, $rollback);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Docker\API\Model\ServiceUpdateResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function serviceUpdateAsync($body, $version, $id, $xRegistryAuth = null, $registryAuthFrom = 'spec', $rollback = null)
    {
        return $this->serviceUpdateAsyncWithHttpInfo($body, $version, $id, $xRegistryAuth, $registryAuthFrom, $rollback)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function serviceUpdateAsyncWithHttpInfo($body, $version, $id, $xRegistryAuth = null, $registryAuthFrom = 'spec', $rollback = null)
    {
        $returnType = '\Docker\API\Model\ServiceUpdateResponse';
        $request = $this->serviceUpdateRequest($body, $version, $id, $xRegistryAuth, $registryAuthFrom, $rollback);
     ...
     * @return RequestInterface
     */
    protected function serviceUpdateRequest($body, $version, $id, $xRegistryAuth = null, $registryAuthFrom = 'spec', $rollback = null): RequestInterface
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($registryAuthFrom !== null) {
            $queryParams['registryAuthFrom'] = ObjectSerializer::toQueryValue($registryAuthFrom, null);
        }
        // query params
        if ($rollback !== null) {
