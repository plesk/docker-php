...
class ExecApi
{
     ...
     *
     * @param  \Docker\API\Model\ExecConfig $body Exec configuration (required)
     ...
     */
    protected function containerExecRequest($body, $id): RequestInterface
    {
     ...
     * @throws \Docker\API\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Docker\API\Model\ExecInspectResponse
     */
     ...
     * @throws \Docker\API\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Docker\API\Model\ExecInspectResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function execInspectWithHttpInfo($id)
    {
        $returnType = '\Docker\API\Model\ExecInspectResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Docker\API\Model\ExecInspectResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return RequestInterface
     */
    protected function execInspectRequest($id): RequestInterface
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return void
     */
    public function execResize($id, $h, $w)
    {
     ...
     */
    public function execResizeWithHttpInfo($id, $h, $w)
    {
        $returnType = '';
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function execResizeAsync($id, $h, $w)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function execResizeAsyncWithHttpInfo($id, $h, $w)
    {
        $returnType = '';
        $request = $this->execResizeRequest($id, $h, $w);
     ...
     * @return RequestInterface
     */
    protected function execResizeRequest($id, $h, $w): RequestInterface
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     *
     * @param  string $id Exec instance ID (required)
     * @param  \Docker\API\Model\ExecStartConfig $body body (optional)
     *
     * @throws \Docker\API\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     *
     * @param  string $id Exec instance ID (required)
     * @param  \Docker\API\Model\ExecStartConfig $body (optional)
     *
     * @throws \Docker\API\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     ...
     * @return RequestInterface
     */
    protected function execStartRequest($id, $body = null): RequestInterface
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
