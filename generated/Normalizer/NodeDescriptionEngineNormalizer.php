...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class NodeDescriptionEngineNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \Docker\API\Model\NodeDescriptionEngine::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \Docker\API\Model\NodeDescriptionEngine::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            if (\array_key_exists('Plugins', $data) && $data['Plugins'] !== null) {
                ...
                foreach ($data['Plugins'] as $value_1) {
                    $values_1[] = $this->denormalizer->denormalize($value_1, \Docker\API\Model\NodeDescriptionEnginePluginsItem::class, 'json', $context);
                }
        ...
        {
            return [\Docker\API\Model\NodeDescriptionEngine::class => false];
        }
    }
} else {
    class NodeDescriptionEngineNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
