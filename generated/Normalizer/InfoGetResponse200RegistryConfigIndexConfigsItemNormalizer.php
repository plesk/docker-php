...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class InfoGetResponse200RegistryConfigIndexConfigsItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \Docker\API\Model\InfoGetResponse200RegistryConfigIndexConfigsItem::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \Docker\API\Model\InfoGetResponse200RegistryConfigIndexConfigsItem::class;
        }
        ...
        {
            return [\Docker\API\Model\InfoGetResponse200RegistryConfigIndexConfigsItem::class => false];
        }
    }
} else {
    class InfoGetResponse200RegistryConfigIndexConfigsItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
