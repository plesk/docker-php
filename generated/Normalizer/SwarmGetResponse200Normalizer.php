...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class SwarmGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \Docker\API\Model\SwarmGetResponse200::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \Docker\API\Model\SwarmGetResponse200::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            if (\array_key_exists('JoinTokens', $data) && $data['JoinTokens'] !== null) {
                $object->setJoinTokens($this->denormalizer->denormalize($data['JoinTokens'], \Docker\API\Model\SwarmGetResponse200JoinTokens::class, 'json', $context));
            }
        ...
        {
            return [\Docker\API\Model\SwarmGetResponse200::class => false];
        }
    }
} else {
    class SwarmGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
