...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class ImageManifestSummaryAttestationDataNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return is_object($data) && get_class($data) === \Docker\API\Model\ImageManifestSummaryAttestationData::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            if (\array_key_exists('For', $data) && $data['For'] !== null) {
                $object->setFor($data['For']);
            }
            elseif (\array_key_exists('For', $data) && $data['For'] === null) {
                $object->setFor(null);
            }
            return $object;
        }
